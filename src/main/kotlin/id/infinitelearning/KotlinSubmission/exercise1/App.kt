 ...
 */
fun myProfile() {
    val firstName: String = "Damar Bambang"
    val lastName: String = "Suwarno"
    val umur: Int = 20
 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Bina", "Rafi", "Rizki", "Yevi", "Berli", "Damar")
    val myName = groupMembers[5]
 ...
 */
fun totalMember(): Int {
    val mentor = arrayOf("Shasa", "Dian", "Reza", "Hazan")
    val countOfGroup = 5
...
fun main() {
     ...
     *
     */
    groupDetail(4, listOf("Bina", "Rafy", "Rizki", "Berli", "Damar", "Yevi"), "Morning")
